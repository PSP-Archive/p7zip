...
solution "p7zip"
  ...
  LD=psp-gcc
   ...
   buildoptions [[
      -I"$(PSPDEV)/psp/sdk/include" -G0 -O2 -g0
   ]]
...
-- includes for all projects
      ...
      syslibdirs { "$(PSPDEV)/psp/sdk/lib/" }
      libdirs { "$(PSPDEV)/psp/sdk/lib/" }
      linkoptions { "-Wl,-S -Wl,--gc-sections -Wl,--undefined=module_info -specs=$(PSPDEV)/psp/sdk/lib/prxspecs -Wl,-q,-T$(PSPDEV)/psp/sdk/lib/linkfile.prx   bin/Debug/liball_c_code.a -lpthread-psp -lstdc++ -lm -lpspdebug -lpspdisplay -lpspge -lpspctrl -lpspsdk -lc -lpspnet -lpspnet_inet -lpspnet_apctl -lpspnet_resolver -lpsputility -lpspuser -lpspkernel" }

      configuration "Debug"
         defines { "DEBUG", "_FILE_OFFSET_BITS=64", "_LARGEFILE_SOURCE", "_REENTRANT", "ENV_UNIX", "BREAK_HANDLER", "UNICODE", "_UNICODE", "UNIX_USE_WIN_FILE", "_7ZIP_ST", "_PSP_FW_VERSION=500" }
         flags { "Symbols" }

      configuration "Release"
         defines { "NDEBUG", "_FILE_OFFSET_BITS=64", "_LARGEFILE_SOURCE", "_REENTRANT", "ENV_UNIX", "BREAK_HANDLER", "UNICODE", "_UNICODE", "UNIX_USE_WIN_FILE", "_7ZIP_ST", "_PSP_FW_VERSION=500" }
         flags { "Optimize" }    
